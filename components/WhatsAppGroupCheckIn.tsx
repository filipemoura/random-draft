        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-neutral-700 rounded-xl p-6 max-w-lg w-full">
                ...
                <div className="space-y-3">
                    <button
                        onClick={sendToGroup}
                        className="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-4 px-6 rounded-lg transition flex items-center justify-center gap-2 text-lg"
                    >
                ...
                {sent && (
                    <div className="mt-4 bg-green-600 bg-opacity-20 border border-green-400 p-3 rounded-lg">
                        <p className="text-green-300 text-sm text-center">
                            ✅ WhatsApp aberto! Cole a mensagem no grupo.
                        </p>
                    </div>
                )}
            </div>
